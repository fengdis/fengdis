...
function checkform()
{
	...
	if (document.getElementById('tijianid').value=="")
	{
		alert("正式体检日期不能为空");
		return false;
	}
      ...
      border=1>
              <TBODY>
               ...
               <TR>
                ...
                <INPUT onClick="showCalendar(this.id)"  <%--onclick="javascript:fPopCalendar(tijianid,tijianid); return false;"--%>  id="tijianid" name=tijian size="30"  />
                ...
                <TR>
                 ...
                 <TH class=gridViewHeader scope=col align="center" >
                     <input type="submit" value="确认登记" style="width: 60px" />
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
