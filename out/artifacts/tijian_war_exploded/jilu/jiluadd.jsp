              ...
              <TBODY>
                <TR>
                  ...
                  <c:if  test="${user.role==3}">
                    <input  type="text" name="mingzi"  id='mingziid'  size="30"  value="${user.truename}"/>
                  </c:if>
                ...
                <TR>
                  ...
                  <TH class=gridViewHeader scope=col>
                    <c:if  test="${user.role==3}">
                      <input  type="text" name="sfz"  id='sfzid'  size="30" value="${user.sfz}" />
                    </c:if>
                    <c:if  test="${user.role==2}">
                ...
                <TR>
                  ...
                  <TH class=gridViewHeader scope=col>
                    <c:if  test="${user.role==3}">
                      <input  type="text" name="dianhua"  id='dianhuaid'  size="30" value="${user.lianxifangshi}" />
                    </c:if>
                    <c:if  test="${user.role==2}">
                ...
                <INPUT onClick="showCalendar(this.id)"  <%--onclick="javascript:fPopCalendar(riqiid,riqiid); return false;"--%>  id="riqiid" name=riqi size="30" />
                  ...
                  <TH class=gridViewHeader scope=col>
                 <select name="taocan">
                 <c:forEach items="${taocanlist}" var="bean">
                  <option value="${bean.id }">套餐名字:${bean.mingzi }&nbsp;&nbsp;&nbsp;&nbsp;套餐费用:${bean.feiyong }</option>
                ...
                <TR>
                  ...
                  <TH class=gridViewHeader scope=col>
                  <textarea rows="7" cols="50" name="beizhi"></textarea>
                  </TH>
